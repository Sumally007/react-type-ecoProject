...
export default function App() {
  return (
    <Router>
      <div className="flex bg-gray-50 w-full max-w-[1440px] mx-auto min-h-screen dark:bg-zinc-950 text-gray-900 dark:text-gray-100 transition-colors duration-300">
        <Sidebar />
